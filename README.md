...
[![npm](https://img.shields.io/npm/v/gift-card-catalog.svg)](https://www.npmjs.com/package/gift-card-catalog)
...
```ts
import { detect, validate, format, canRedeem } from 'gift-card-catalog';
